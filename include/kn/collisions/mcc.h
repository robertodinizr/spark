...
enum class CollisionProjectile { Ion, Electron };

enum class CollisionType { Ionization, Excitation, Elastic, Isotropic, Backscattering };
...
public:
    ...
    int collide_electrons(particle::ChargedSpecies<NX, 3>& electrons,
                          particle::ChargedSpecies<NX, 3>& ions);

    void collide_ions(particle::ChargedSpecies<NX, 3>& ions);
...
private:
    ...
    double nu_prime_electrons_max(const CollisionReaction& cs);
    double nu_prime_ions_max(const CollisionReaction& cs);

    double frequency_ratio(const CollisionReaction& cs, double kinetic_energy);

    void isotropic_coll(particle::ChargedSpecies<NX, 3>& species,
                        size_t idx,
                        double vmag,
                        double chi);

    bool electron_elastic_coll(particle::ChargedSpecies<NX, 3>& electrons,
                               particle::ChargedSpecies<NX, 3>& ions,
                               size_t p_idx,
                               double kinetic_energy);

    bool electron_excitation_coll(particle::ChargedSpecies<NX, 3>& electrons,
                                  particle::ChargedSpecies<NX, 3>& ions,
                                  size_t p_idx,
                                  double kinetic_energy,
                                  double threshold);

    bool electron_ionization_coll(particle::ChargedSpecies<NX, 3>& electrons,
                                  particle::ChargedSpecies<NX, 3>& ions,
                                  size_t p_idx,
                                  double kinetic_energy,
                                  double threshold);

    bool ions_isotropic_coll(particle::ChargedSpecies<NX, 3>& ions,
                             size_t p_idx,
