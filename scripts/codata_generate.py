"""
This script is used to generate the sci_constants.h header 
"""
...
def parse_codata_ascii_text(d: str) -> dict[str, tuple[float, str, float]]:
    constants = {}
    for line in d.split('\n'):
        name = line[:60].rstrip()
...
if __name__ == '__main__':
    ...
    constants = parse_codata_ascii_text(codata_ascii_2018)
    pass